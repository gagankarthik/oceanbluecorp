...
// Namespace import, not a default. maplibre-gl v6 removed the default export
// that this component was written against; every member it uses (Map, Marker,
// Popup and the types) is a named export, so the namespace form works on v6
// without pinning the library back to v5.
