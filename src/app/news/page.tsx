...
export default function News() {
  return (
    <ComingSoon
      eyebrow="News"
      title="Announcements, awards, and company updates."
      subtitle="What is happening at Ocean Blue, from new certifications to new delivery centres."
      note="There are no announcements posted yet. For press or partnership enquiries, contact us and we will come straight back to you."
    />
  );
}
