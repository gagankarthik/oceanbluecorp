  ...
  return (
    <div className="horizon w-full bg-[var(--hz-canvas)]">
      ...
      {/* The "How we build / Owned end to end" grid of three icon tiles was
          ...
          sitting above the two products it was meant to introduce. */}
      ...
      <section className="relative w-full py-20 sm:py-28 lg:py-32">
        <div className="mx-auto max-w-7xl px-6 sm:px-8">
          <Reveal className="max-w-2xl">
            ...
            <h2 className="hz-display mt-6 text-[clamp(1.75rem,3.6vw,3rem)] text-[var(--hz-text)]">Platforms in production.</h2>
          </Reveal>
      ...
      <section className="relative isolate w-full overflow-hidden" style={{ background: "#07142b" }}>
        ...
        <div className="relative z-10 mx-auto max-w-3xl px-6 py-20 text-center sm:px-8 sm:py-28 lg:py-32">
          <Reveal className="flex flex-col items-center">
            ...
            <h2 className="hz-display mt-7 max-w-[18ch] text-[clamp(1.9rem,4.6vw,3rem)] text-white">Have a product to build or scale?</h2>
