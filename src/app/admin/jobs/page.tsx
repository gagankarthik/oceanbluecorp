...
import {
  ...
  Calendar, PauseCircle, FileText, TrendingUp, AlertTriangle,
} from "lucide-react";
        ...
        <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
          ...
          {filteredJobs.length === 0 && (
            <div className="py-16 text-center">
              ...
              {jobs.length === 0 && canEdit && (
                <button onClick={() => router.push("/admin/jobs/new")} className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700">
